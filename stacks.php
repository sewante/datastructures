...
?>
		<div class="article">
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				print("<p>Time taken to construct stack: {$duration} seconds.</p>");
		  ...
		  <div class="article">
            <h2><span>Try Stacks</span></h2>
            <div class="clr"></div>
			<?php echo "<p>Construct a stack for " . NUM_STUDENTS . " student records.</p>"; ?>
        ...
        <div class="sidebar">
          <div class="gadget">
            ...
            <div class="clr"></div>
            <ul class="sb_menu">
				<li class="active"><a href="stacks.php">Stacks</a></li>
